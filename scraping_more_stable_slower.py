...
class FlyerScraper:
    ...
    def parse_hypermarkets(self):
        ...
        for market in hypermarket_list:
            ...
            start_count = self.flyers_count
            self.parse_flyers_for_shop(transfer_url, shop_name)
            flyers_added = self.flyers_count - start_count
            print(f"{shop_name}: {flyers_added} flyers added")
    ...
    def parse_flyers_for_shop(self, transfer_url, shop_name):
        ...
        print(f"Parsed {shop_flyer_count} flyers from {shop_name}")
    ...
    def save_to_json(self):
        ...
        print(f'Data saved to flyers_data.json - Total Flyers: {self.flyers_count}')
